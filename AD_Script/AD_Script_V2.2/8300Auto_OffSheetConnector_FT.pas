...
// 在 A1 位置生成 Power Ports 或 Connectors
for i := 0 to 31 do
begin
    if PortNamesA1[i] <> '' then
    begin
        if (PortNamesA1[i] = 'AGND') or (PortNamesA1[i] = 'GND') or
           (PortNamesA1[i] = 'DGND') or (PortNamesA1[i] = 'JGND') then
        begin
        ...
        begin
            ...
            begin
                Connector.Location := PositionA1[i];
                Connector.Text := PortNamesA1[i];
...
// 在 B1 位置生成 Power Ports 或 Connectors
for i := 0 to 31 do
begin
    if PortNamesB1[i] <> '' then
    begin
        if (PortNamesB1[i] = 'AGND') or (PortNamesB1[i] = 'GND') or
           (PortNamesB1[i] = 'DGND') or (PortNamesB1[i] = 'JGND') then
        begin
            PowerPort := SchServer.SchObjectFactory(ePowerObject, eCreate_Default);
            if PowerPort <> nil then
            begin
        ...
        begin
            ...
            if Connector <> nil then
            begin
                Connector.Location := PositionB1[i];
                Connector.Text := PortNamesB1[i];
                SchDoc.RegisterSchObjectInContainer(Connector);
            end;
        end;
    end;
...
// 在 C1 位置生成 Power Ports 或 Connectors
for i := 0 to 31 do
begin
    if PortNamesC1[i] <> '' then
    begin
        if (PortNamesC1[i] = 'AGND') or (PortNamesC1[i] = 'GND') or
           (PortNamesC1[i] = 'DGND') or (PortNamesC1[i] = 'JGND') then
        begin
            PowerPort := SchServer.SchObjectFactory(ePowerObject, eCreate_Default);
            if PowerPort <> nil then
            begin
        ...
        begin
            ...
            if Connector <> nil then
            begin
                Connector.Location := PositionC1[i];
                Connector.Text := PortNamesC1[i];
                SchDoc.RegisterSchObjectInContainer(Connector);
            end;
        end;
    end;
...
// 在 A2 位置生成 Power Ports 或 Connectors
for i := 0 to 31 do
begin
    if PortNamesA2[i] <> '' then
    begin
        if (PortNamesA2[i] = 'AGND') or (PortNamesA2[i] = 'GND') or
           (PortNamesA2[i] = 'DGND') or (PortNamesA2[i] = 'JGND') then
        begin
            PowerPort := SchServer.SchObjectFactory(ePowerObject, eCreate_Default);
            if PowerPort <> nil then
            begin
        ...
        begin
            ...
            if Connector <> nil then
            begin
                Connector.Location := PositionA2[i];
                Connector.Text := PortNamesA2[i];
                SchDoc.RegisterSchObjectInContainer(Connector);
            end;
        end;
    end;
...
// 在 B2 位置生成 Power Ports 或 Connectors
for i := 0 to 31 do
begin
    if PortNamesB2[i] <> '' then
    begin
        if (PortNamesB2[i] = 'AGND') or (PortNamesB2[i] = 'GND') or
           (PortNamesB2[i] = 'DGND') or (PortNamesB2[i] = 'JGND') then
        begin
            PowerPort := SchServer.SchObjectFactory(ePowerObject, eCreate_Default);
            if PowerPort <> nil then
            begin
        ...
        begin
            ...
            if Connector <> nil then
            begin
                Connector.Location := PositionB2[i];
                Connector.Text := PortNamesB2[i];
                SchDoc.RegisterSchObjectInContainer(Connector);
            end;
        end;
    end;
...
// 在 C2 位置生成 Power Ports 或 Connectors
for i := 0 to 31 do
begin
    if PortNamesC2[i] <> '' then
    begin
        if (PortNamesC2[i] = 'AGND') or (PortNamesC2[i] = 'GND') or
           (PortNamesC2[i] = 'DGND') or (PortNamesC2[i] = 'JGND') then
        begin
            PowerPort := SchServer.SchObjectFactory(ePowerObject, eCreate_Default);
            if PowerPort <> nil then
            begin
        ...
        begin
            ...
            if Connector <> nil then
            begin
                Connector.Location := PositionC2[i];
                Connector.Text := PortNamesC2[i];
                SchDoc.RegisterSchObjectInContainer(Connector);
            end;
        end;
    end;
...
// 在 A3 位置生成 Power Ports 或 Connectors
for i := 0 to 31 do
begin
    if PortNamesA3[i] <> '' then
    begin
        if (PortNamesA3[i] = 'AGND') or (PortNamesA3[i] = 'GND') or
           (PortNamesA3[i] = 'DGND') or (PortNamesA3[i] = 'JGND') then
        begin
            PowerPort := SchServer.SchObjectFactory(ePowerObject, eCreate_Default);
            if PowerPort <> nil then
            begin
        ...
        begin
            ...
            if Connector <> nil then
            begin
                Connector.Location := PositionA3[i];
                Connector.Text := PortNamesA3[i];
                SchDoc.RegisterSchObjectInContainer(Connector);
            end;
        end;
    end;
...
// 在 B3 位置生成 Power Ports 或 Connectors
for i := 0 to 31 do
begin
    if PortNamesB3[i] <> '' then
    begin
        if (PortNamesB3[i] = 'AGND') or (PortNamesB3[i] = 'GND') or
           (PortNamesB3[i] = 'DGND') or (PortNamesB3[i] = 'JGND') then
        begin
            PowerPort := SchServer.SchObjectFactory(ePowerObject, eCreate_Default);
            if PowerPort <> nil then
            begin
        ...
        begin
            ...
            if Connector <> nil then
            begin
                Connector.Location := PositionB3[i];
                Connector.Text := PortNamesB3[i];
                SchDoc.RegisterSchObjectInContainer(Connector);
            end;
        end;
    end;
...
// 在 C3 位置生成 Power Ports 或 Connectors
for i := 0 to 31 do
begin
    if PortNamesC3[i] <> '' then
    begin
        if (PortNamesC3[i] = 'AGND') or (PortNamesC3[i] = 'GND') or
           (PortNamesC3[i] = 'DGND') or (PortNamesC3[i] = 'JGND') then
        begin
            PowerPort := SchServer.SchObjectFactory(ePowerObject, eCreate_Default);
            if PowerPort <> nil then
            begin
        ...
        begin
            ...
            if Connector <> nil then
            begin
                Connector.Location := PositionC3[i];
                Connector.Text := PortNamesC3[i];
                SchDoc.RegisterSchObjectInContainer(Connector);
            end;
        end;
    end;
...
// 在 A4 位置生成 Power Ports 或 Connectors
for i := 0 to 31 do
begin
    if PortNamesA4[i] <> '' then
    begin
        if (PortNamesA4[i] = 'AGND') or (PortNamesA4[i] = 'GND') or
           (PortNamesA4[i] = 'DGND') or (PortNamesA4[i] = 'JGND') then
        begin
            PowerPort := SchServer.SchObjectFactory(ePowerObject, eCreate_Default);
            if PowerPort <> nil then
            begin
        ...
        begin
            ...
            if Connector <> nil then
            begin
                Connector.Location := PositionA4[i];
                Connector.Text := PortNamesA4[i];
                SchDoc.RegisterSchObjectInContainer(Connector);
            end;
        end;
    end;
...
// 在 B4 位置生成 Power Ports 或 Connectors
for i := 0 to 31 do
begin
    if PortNamesB4[i] <> '' then
    begin
        if (PortNamesB4[i] = 'AGND') or (PortNamesB4[i] = 'GND') or
           (PortNamesB4[i] = 'DGND') or (PortNamesB4[i] = 'JGND') then
        begin
            PowerPort := SchServer.SchObjectFactory(ePowerObject, eCreate_Default);
            if PowerPort <> nil then
            begin
        ...
        begin
            ...
            if Connector <> nil then
            begin
                Connector.Location := PositionB4[i];
                Connector.Text := PortNamesB4[i];
                SchDoc.RegisterSchObjectInContainer(Connector);
            end;
        end;
    end;
...
// 在 C4 位置生成 Power Ports 或 Connectors
for i := 0 to 31 do
begin
    if PortNamesC4[i] <> '' then
    begin
        if (PortNamesC4[i] = 'AGND') or (PortNamesC4[i] = 'GND') or
           (PortNamesC4[i] = 'DGND') or (PortNamesC4[i] = 'JGND') then
        begin
            PowerPort := SchServer.SchObjectFactory(ePowerObject, eCreate_Default);
            if PowerPort <> nil then
            begin
        ...
        begin
            ...
            if Connector <> nil then
            begin
                Connector.Location := PositionC4[i];
                Connector.Text := PortNamesC4[i];
                SchDoc.RegisterSchObjectInContainer(Connector);
            end;
        end;
    end;
...
// 定义 8 个独立的函数
procedure ImportOffSheetConnector_Connector_X1X4;
begin
    ImportPowerPortsFromCSV('C:\Users\63263\Desktop\Test\Connector_X1-X16_1-4.csv');
end;

procedure ImportOffSheetConnector_Connector_X5X8;
begin
    ImportPowerPortsFromCSV('D:\Acco_脚本\AD8300自动脚本\8300Auto_PowerPorts_demo_V1.2\Connector_X5-8.csv');
end;

procedure ImportOffSheetConnector_Connector_X9X12;
begin
    ImportPowerPortsFromCSV('D:\Acco_脚本\AD8300自动脚本\8300Auto_PowerPorts_demo_V1.2\Connector_X9-12.csv');
end;

procedure ImportOffSheetConnector_Connector_X13X16;
begin
